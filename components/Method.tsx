...
const stages = [
  { n: "01", title: "EVALUAMOS", text: "Analizamos tu estado actual, objetivos y experiencia.", img: "/images/evaluamos.png" },
  { n: "02", title: "MEDIMOS", text: "Registramos indicadores de evolución disponibles y confiables.", img: "/images/medimos.png" },
  { n: "03", title: "PLANIFICAMOS", text: "Diseñamos el entrenamiento y plan nutricional según tus objetivos.", img: "/images/planificamos.png" },
  { n: "04", title: "ENTRENAMOS", text: "Sesiones personalizadas enfocadas en técnica, fuerza y progreso.", img: "/images/etrenamos.png" },
  { n: "05", title: "AJUSTAMOS", text: "Revisamos tu evolución y adaptamos el programa cuando es necesario.", img: "/images/ajustamos.png" },
  { n: "06", title: "EVOLUCIONAMOS", text: "Resultados reales, nuevos hábitos y nuevas metas.", img: "/images/evolucionamos.png" },
];
